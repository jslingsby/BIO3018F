...
- Some basics of research design (Claire)
- Scientific writing (Claire)
- Power analysis (Jasper)

Scheduled Sessions:
- Two afternoons and half a morning to develop your projects
...
- 3,500 words maximum, including references.
...
- Clearly state your research question(s) and hypothesis(es) - based on guidance from Claire's lecture
- Provide your power analysis and justification for your sampling design. Describe it in your methods and present it in your results. Note that few papers present a power analysis even if they do them, but we are asking you to do and present one as it is a good practice to follow and can tell you whether your project is doomed from the start... Also note that you don't necessarily have to abandon your independent project if your power analysis says you're doomed from the start. You're not expected to collect a perfect dataset in 2 afternoons!
...
- Feel free to highlight the shortcomings of your study and what could be done to improve it (e.g. discuss your power analysis).
...
- You may NOT plaigarise. This is considered to be academic misconduct and is a very serious offence, with severe consequences. 

- You may use ChatGPT and other AI tools to help write R code etc, but you must acknowledge its use appropriately. 

- Please do not use ChatGPT or other AI tools to write the text of your paper. See the section on "AI Tools and Academic Integrity" in the [**UCT Student Guide on AI**](https://docs.google.com/document/d/1llgONbM6qc5eklUjUnvsFabw3NL5sgSFKnXKGUcbVBw/edit?tab=t.0#heading=h.2l0fhbx9j38i). It is a disservice to yourself as you will not learn scientific writing, which will limit your scientific thinking. Why pay the University so you can cheat yourself? It is also an insult to us as your instructors, as we have to read and mark it.
