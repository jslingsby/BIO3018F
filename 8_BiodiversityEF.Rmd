...
.footnote[*i.e. dashed line exceeds points on the graph at Nspp = 1]
]
...
Greater environmental heterogeneity at the regional scale means adding species with different niche preferences should increase EF (but not so in homogenous regions).
...
```
.footnote[van der Plas 2019 found varied support - mostly positive results (green), but many ambivalent (yellow) or negative (red).]
