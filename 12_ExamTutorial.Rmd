...
The final mark allocation by lecturer for the course (across the test and exam) is roughly proportional to the number of lectures in their section, discounted by their contribution to tests etc. That said, all sections are relevant to the exam, especially given the integrative nature of the essays.
