...
Note that we've only recently been trying to come up with clear definitions so there are still grey areas - e.g. most "supporting services" are probably ecosystem precesses...
