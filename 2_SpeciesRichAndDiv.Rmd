...
Here a community is considered more diverse if the relative abundances are more evenly distributed, because removing one individual is less likely to remove a species.
...
The size and density of individuals can also affect the shape of the species-area relationship (SAR) at fine scales.
...
We often use the SAR to estimate the diversity of a larger area by extrapolation.
...
You need to choose your measure of diversity carefully, and potentially correct for these sampling effects (e.g. by using rarefaction, sampling a larger area, etc), depending on the group you're working on and your question at hand.
