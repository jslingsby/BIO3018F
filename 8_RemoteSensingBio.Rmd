---
title: "8. Remote Sensing of Biodiversity"
subtitle: ""  
author: 
...
.left[.footnote[Moncrieff in review]]
...
Imaging spectroscopy ("hyperspectral" remote sensing) allows direct measurement of many leaf traits.

```{r echo = F, fig.align = 'left', out.width = '86%'}
...
##Of course there are challenges and limitations...
...
##But this is what fancy modelling is for...
...
Identifying parcels of Earth that are valuable for their capacity to support diverse life forms today and into the future
