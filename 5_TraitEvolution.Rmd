...
If each trait is a dimension (axis in the figure), trade-offs dictate that the "volume" of the trait space is constrained (cannot be filled).

<br>

Here, null models that assume no trade-offs (random trait combinations) cannot reproduce the observed trait combinations (a constrained convex "hull" within trait space).
...
Note that most woody plants are dicotyledonous, while most non-woody are monocotyledonous plants (grasses, sedges, restios, orcids, etc).
...
.pull-right[
```{r echo = F, fig.align = 'center', out.width = '88%'}
...
*Trade-offs among traits limit the spectrum of potential trait combinations, constraining life-history strategies and niche space.*
