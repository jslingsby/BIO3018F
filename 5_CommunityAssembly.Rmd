...
(phylogenetic signal and niche conservatism)
...
*The distribution and abundance of diversity is determined by assembly processes that operate from local to regional scales*

*While the distinction between local and regional processes is somewhat arbitrary (or even artificial), we typically consider local scale processes to be ecological, operating over the near term, while regional processes are typically evolutionary, operating over longer periods of time*

*We can explore these processes by looking at functional and phylogenetic diversity at different scales (species pools), often in combination with null models*
---
