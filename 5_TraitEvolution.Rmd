...
The leaf economics spectrum (LES) - Wright et al. 2004

- Leaf dry mass per unit area (LMA) predicts N content, photosynthetic capacity and growth rate
...
```
- Correlates with environment (temp and rainfall)
...
Traits and combinations vary among lineages...
]
...
Null models "randomize" properties of interest in the data, servings as a "null expectation" for comparison to your actual data. 
...
See Gotelli and Graves 1996 for a thorough treatment.
