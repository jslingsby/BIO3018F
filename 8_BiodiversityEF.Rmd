...
Ecosystem services are the benefits humans derive from ecosystem functions (directly or indirectly).
...
.footnote[From Slingsby et al. 2014. Hypothetical curves based on literature. Time span ~15 yrs. Seasonality excluded.]
]
...
Supported by models (a, b) and experiments (c, d), BUT more species means less species-level stability (consistent with niche theory).
