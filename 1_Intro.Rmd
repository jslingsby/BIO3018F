...
## My research focuses on three questions...

```{r echo = F, fig.align = 'center', out.width = '65%'}
knitr::include_graphics("images/chapin.png")
```

1. What determines the distribution and abundance of biodiversity?
...
.pull-right[
.footnote[Modified from Chapin et al. 1997, _Science_]
]
...
So it's crucial that we master the methods for measuring and analyzing biodiversity data if we hope to answer the questions at hand...
