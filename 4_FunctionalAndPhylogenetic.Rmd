...
A molecular phylogeny (or "phylogenetic tree") represents the relationships between species based on similarity of their DNA. Branch lengths are usually time-calibrated based on a molecular clock (rate of mutation through time) to represent time. 
- The sum of the branch lengths linking species in a sample represents the _sum total independent evolutionary history_ represented by that sample.
