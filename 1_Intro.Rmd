...
.pull-left[
## This module will focus on community composition
...
kable(ebvs)  %>%
  kable_styling(font_size = 12) %>%
  row_spec(11:13, bold = T, color = "white", background = "#23395b")
```
]
...
2. What is the role of biodiversity in ecosystem function?
