...
### And how do these processes vary with spatial scale?
...
- often explored by looking at species traits, assuming they reflect resource use strategies
...
_Fundamental species pool_ = species with the potential to occur in a particular location (i.e. have the ability to disperse there and survive the abiotic conditions)

_Realised community_ = the actual observed local community (i.e. a subset of the fundamental species pool that managed to get there and to coexist, either stably or unstably)
