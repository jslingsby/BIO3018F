...
The final mark allocation by lecturer for the course (across the test and exam) is _**roughly**_ proportional to the number of lectures in their section, discounted by their contribution to tests etc. That said, all sections are relevant to the exam, especially given the integrative nature of the essays.

So the mark allocation across the 4 questions (200 marks) in the exam is roughly (this is not exact):
