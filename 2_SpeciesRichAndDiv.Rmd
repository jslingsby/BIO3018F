...
##### Species counts relative to number of individuals sampled across 81 vegetation plots in Table Mountain National Park (data from Slingsby et al. 2017).
...
##### Species counts relative to number of individuals sampled for each of 81 vegetation plots in Table Mountain National Park (data from Slingsby et al. 2017).
]
...
##### Individual-based rarefaction curve developed by sampling individuals from the pooled data from 81 vegetation plots in Table Mountain National Park (data from Slingsby et al. 2017).
]
...
.footnote[<sup>1</sup>for a given *n*]
