...
- Are species in communities more closely (or distantly) related than we'd expect?
- Are species in communities more functionally similar (or dissimilar) than we'd expect?
]
...
Null models can be used to "randomize" properties of interest in the data. 

There are a number of ways of doing this, but the key is to try to make sure you only randomize the property of interest and keep everything else the same.

Properties include:
- The functional or phylogenetic relationships among species
- The abiotic (or spatial) relationships among sites
- The numbers of species in communities (the row sums)
- The numbers of occurrences (and/or abundances) of each species across all communities
- Etc
