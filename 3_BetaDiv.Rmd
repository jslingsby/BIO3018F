...
.footnote[Values range from 0 (identical communities) to 1 (complete turnover).]
...
.pull-right[
Eudicots of the Baetic mountains of Andalusia, Spain (Molina‐Venegas et al. 2015)
...
```{r echo = F, fig.align = 'right', out.width = '70%'}
...
Community similarity in relation to age since last fire
...
>*"This applies to most measures of diversity..."* - Slingsby 2022
