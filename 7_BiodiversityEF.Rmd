...
- This is largely because most lineages are dominated by the same 10 or so lineages.
- These species look similar, and have similar effects in the environment, but must be responding differently to occur in such different environments
...
- Open (Fynbos, grassland, savanna) vs closed (forest)
